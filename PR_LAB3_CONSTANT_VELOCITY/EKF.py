...
class EKF(GaussianFilter):
    ...
    def Update(self, zk, Rk, xk_bar, Pk_bar, Hk, Vk, received_encoder_readings, received_heading_data):
        """
        ...
        :param received_encoder_readings: Received encoder readings.
        :param received_heading_data: Received heading data.
        ...
        # I_KH = np.eye(len(self.xk)) - K @ Hk
        # self.Pk = I_KH @ self.Pk_bar @ I_KH.T + K @ self.Rk @ K.T
        ...
        innovation = self.zk - self.h(self.xk_bar, received_encoder_readings, received_heading_data)

        if received_heading_data:
